          ...
          <main className="min-h-screen flex justify-center py-4 md:py-6 md:px-12 lg:py-8 lg:px-16 bg-gray-100">
              <div className="w-full md:w-[380px] flex flex-col gap-4 border border-gray-200 rounded-md bg-gray-50 p-2 md:p-6">
               <div className="flex justify-center">
                ...
                <p className="text-center py-3 border-b border-gray-600">Augustine Emmanuel Chukwuemeka</p>
                <p className="text-center py-3 border-b border-gray-600">augustinemekus2026@gmail.com</p>
                <p className="text-center py-3 border-b border-gray-600">UC4217</p>
